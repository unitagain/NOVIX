...
_ROUTE_TOOLS = {
    "agentic_writer": ("lookup_card", "query_canon", "query_relations", "read_chapter", "search_prose", "write_content", "edit_lines"),
    "plan_workflow": ("lookup_card", "query_canon", "query_relations", "read_chapter", "search_prose"),
